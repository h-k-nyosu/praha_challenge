...
CREATE TABLE IF NOT EXISTS workspaces (
    ...
    `workspace_status_id` INT NOT NULL COMMENT "ワークスペースステータスID",
...
CREATE TABLE IF NOT EXISTS users_workspaces (
    ...
    `workspace_join_status_id` INT NOT NULL COMMENT "チャンネル参加ステータスID",
    FOREIGN KEY (`user_id`) REFERENCES users (`id`),
...
CREATE TABLE IF NOT EXISTS channels (
    ...
    `channel_status_id` INT NOT NULL COMMENT "チャンネルステータスID",
    FOREIGN KEY (`workspace_id`) REFERENCES workspaces (`id`),
    FOREIGN KEY (`user_id`) REFERENCES users (`id`),
...
CREATE TABLE IF NOT EXISTS users_channels (
    ...
    `channel_join_status_id` INT NOT NULL COMMENT "チャンネル参加ステータスID",
    FOREIGN KEY (`user_id`) REFERENCES users (`id`),
